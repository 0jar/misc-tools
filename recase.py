...
def main():
    ...
    g.add_argument("-e", "--encode", choices=["b64", "url", "html"], help="Encode text (base64, url, html)")
    g.add_argument("-d", "--decode", choices=["b64", "url", "html"], help="Decode text (base64, url, html)")
